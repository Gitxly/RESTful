...
public class RestController {
	...
	/**
	 * 执行添加 /user   post
	 * 前端请求方式post,参数是表单提交形式
	 * 后台Cintroller 参数User 可以直接封装成功
	 */
	...
	public ResultObject delete(@PathVariable("id") int id) {
		System.out.println("Controller delete 接收到的id : "+id);
	...
	@ResponseBody // 将后台发出的java对象 -> json对象 ,放在方法上
	public ResultObject update(@RequestBody User user) { //将前台发出的json数据 -> java对象,放在对应的参数(@RequestBody User user)
